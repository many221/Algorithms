let departments = [
  ...
  let omni = [departments,employeeDepartment,employees,employeeSalaries]

  // omni[0] = departments,  omni[1] = employeeDepartment, omni[2] = employees, omni[3] = employeeSalareis

  for (let index = 0; index < omni[1].length; index++) {
...
// Challenge 1 -- Log 1-40  Employees Name & Department Name
...
/*
        ...
        _            _    _      _        _____       _       _   _                                                              
       | |          | |  (_)    ( )      / ____|     | |     | | (_)                                                             
       | | __ _  ___| | ___  ___|/ ___  | (___   ___ | |_   _| |_ _  ___  _ __                                                   
   _   | |/ _` |/ __| |/ / |/ _ \ / __|  \___ \ / _ \| | | | | __| |/ _ \| '_ \                                                  
  | |__| | (_| | (__|   <| |  __/ \__ \  ____) | (_) | | |_| | |_| | (_) | | | |                                                 
   \____/ \__,_|\___|_|\_\_|\___| |___/ |_____/ \___/|_|\__,_|\__|_|\___/|_| |_|                                                 
...
for (let i = 0; i < employeeDepartment.length; i++) {
    ...
    depID = employeeDepartment[i][1]
    empID = employeeDepartment[i][0]

   // ID.push([depID,empID])
   if (employeeDepartment[i+1] != undefined && empID != employeeDepartment[i+1][0] || i == employeeDepartment.length - 1) {  
   
        for (let j = 0; j < employees.length; j++) {
            
                if (empID == employees[j][0]) {
                
                        for (let k = 0; k < departments.length; k++) {
                            
                            if (depID == departments[k][0]) {
                                
                                   // console.log(`${employees[j][2]} ${employees[j][3]} works in ${departments[k][1]}`);
                            }
...
/*
       ...
       | |     / _|/ _( )      / ____|     | |     | | (_)            
       | | ___| |_| |_|/ ___  | (___   ___ | |_   _| |_ _  ___  _ __  
   _   | |/ _ \  _|  _| / __|  \___ \ / _ \| | | | | __| |/ _ \| '_ \ 
  | |__| |  __/ | | |   \__ \  ____) | (_) | | |_| | |_| | (_) | | | |
   \____/ \___|_| |_|   |___/ |_____/ \___/|_|\__,_|\__|_|\___/|_| |_|
...
/*
  ...
  |  _ \         | | | | ( )      / ____|     | |     | | (_)                                                                                                                                          
  | |_) |_ __ ___| |_| |_|/ ___  | (___   ___ | |_   _| |_ _  ___  _ __                                                                                                                                
  |  _ <| '__/ _ \ __| __| / __|  \___ \ / _ \| | | | | __| |/ _ \| '_ \                                                                                                                               
  | |_) | | |  __/ |_| |_  \__ \  ____) | (_) | | |_| | |_| | (_) | | | |                                                                                                                              
  |____/|_|  \___|\__|\__| |___/ |_____/ \___/|_|\__,_|\__|_|\___/|_| |_|                                                                                                                              
   ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ 
  |______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|______|
...
for (let i = 0; i < employeeSalaries.length; i++) {
  if (employeeSalaries[i][1] > 60000) {
    ...
    const empIdx = employeeSalaries[i][0] - 1001

    console.log(employees[empIdx][2], employees[empIdx][3], employeeSalaries[empIdx][1]);
...
//     if (ID[i][0] == employees[i][0]) {

//         names.push(employees[i][2] + ' '+ employees[i][3]);
